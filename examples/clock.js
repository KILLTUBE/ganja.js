...
// Initial version by Ted Corcovilos (2020, MIT license)
// Changes from kung foo man (2020-2021)
...
Algebra(2,0,1, () => {
    ...
    document.body.appendChild(this.graph(()=>{
        ...
        var Step1 = E**(-0.5*Lhour*1e02)*E**(PI*hour*O/format);
        var H = ~Step1 * O * Step1;
        var Step2 = E**(-0.5*Lmin*1e02)*E**(PI*minute*H/60.);
        var M = ~Step2 * H * Step2;
        var Step3 = E**(-0.5*Lsec*1e02)*E**(PI*second*M/60.);
        var S = ~Step3 * M * Step3;
